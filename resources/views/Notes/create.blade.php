            ...
            <form method="POST" action="{{route('note-submit')}}">
                @csrf
                    <div class="" style="margin-bottom: 1.25rem;">
                        ...
                        <input type="text" name="title" id="title" class="" value="{{ old('title') }}" style="border-radius: 0.375rem; border-color: #D1D5DB; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); width:100%;" 
                    ...
                    <div class="" style="margin-bottom: 1.25rem;">
                        ...
                        <textarea name="description" id="description" class="" style="border-radius: 0.375rem;
